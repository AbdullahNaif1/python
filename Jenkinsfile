pipeline {
    ...
    stages {
        ...
        stage('Push Docker Image') {
            steps {
                withCredentials([usernamePassword(credentialsId: 'a4b9b0e5-98af-4e18-9da6-3faca9f8a308', usernameVariable: 'abdullah919191', passwordVariable: 'dckr_pat_IaC3FgR-PKqMg-WIAH6T4ztLQOU')]) {
